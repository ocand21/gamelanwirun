<!--slider menu-->
    <div class="sidebar-menu">
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Form</span><span class="fa fa-angle-right" style="float: right"></span></a>
             ...
             @if (Auth::user()->hasRole('admin'))
		         <li><a href="#"><i class="fa fa-cog"></i><span>Sistem</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
